...
public static class SimplePool
{
    ...
    {
        GameUnit gameUnit = Spawn(poolType);
    ...
    public static GameUnit Spawn(PoolType poolType, Transform parent)
    {
        GameUnit gameUnit = Spawn(poolType);

        gameUnit.tf.parent = parent;
    ...
    public class Pool
    {
        ...
        public void Despawn(GameUnit gameUnit)
        {
            ...
            if (gameUnit.transform.parent != parent)
            {
